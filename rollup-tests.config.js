...
export default {
  ...
  // Vitest's browser context is provided by the runner, not bundled: inlining it trips
  // its own "can be imported only inside the Browser Mode" guard. Tests that photograph
  // what they render import it.
  external: ['@vitest/browser/context'],
  output: {
